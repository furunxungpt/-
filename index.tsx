...
const CENTRAL_SOES_LIST = [
  ...
  // Broadly considered Central SOEs (Ministry of Finance managed, etc.) typically expected by users
  "中国邮政集团有限公司", "中国国家铁路集团有限公司", "中国投资有限责任公司"
];
